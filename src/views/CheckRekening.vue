                        ...
                        <b-row class="p-10">
                            ...
                            <b-col cols="12" lg="7" md="12" sm="12">
                                <div class="text-detail text-white txt-shadow">
                                    <h3>{{norekening}} <b-icon icon="check-circle-fill" v-if="dataPemilikRekening.statusKredibel=='Verified'"></b-icon></h3> 
                        ...
                        <b-row class="m-t-10" >
                            <b-col cols="12" lg="5" md="12" sm="12">
                                <div class="boxed-detail">                                        
                                    ...
                                    <h6>{{dataPemilikRekening.pemilik}}</h6>
                                </div>
                                <div class="boxed-detail">                                        
                                    <h5 class="txt-blue">Negara</h5>
                                    <h6>{{dataPemilikRekening.negara}}</h6>
                                </div>
                                <div class="boxed-detail">                                        
                                    <h5 class="txt-blue">Nomor Rekening</h5>
                                    <h6>{{norekening}}</h6>
                                </div>
                                <div class="boxed-detail">                                        
                                    <h5 class="txt-blue">Nama Bank</h5>
                                    <h6>{{dataPemilikRekening.bank}}</h6>
                                </div>                        
                            </b-col>
                            <b-col cols="12" lg="7" md="12" sm="12" class="">
                                <div class="boxed-detail-large bc-shadow">                                        
                                    <h4 class="txt-blue">Status</h4>
                                    <h5>{{dataPemilikRekening.statusKredibel}}</h5>
                                </div>
                                <div class="boxed-detail-large bc-shadow">                                        
                                    <h4 class="txt-blue">Laporan</h4>
                                    <h5>{{dataPemilikRekening.laporanKredibel}} kali dilaporkan</h5>
                                </div>
                                <div class="boxed-detail-large bc-shadow">                                        
                                    <h4 class="txt-blue">Rating</h4>
                                    <b-form-rating id="rating-inline" class="rating" variant="warning" v-model="dataPemilikRekening.ratingKredibel" inline no-border readonly ></b-form-rating>                                    
                                    <label for="rating-inline"><h5>{{dataPemilikRekening.ratingKredibel}}/5</h5></label>                                    
                                </div>
                            </b-col>
                        </b-row>
                    </div>
                ...
                <div class="card-group p-b-20">  
                    <div class="card b-r">
                        ...
                        <div class="card-body">
                            ...
                            <input type="button" class="btn-cs btn-cs-blue" value="Go somewhere" to="">
                        </div>
                    </div>  
                </div>          
            </div>
            ...
            <div class="container m-t-10 p-20 b-r bc-white bc-shadow">
                ...
                <div class="boxed-scroll-y">
                    <div class="boxed-detail border-bottom p-b-5 m-b-20" v-for="review of reviews" :key="review.id">                        
                        <b-form-rating class="rating m-b-5" variant="warning" v-model="review.star" inline no-border readonly ></b-form-rating> 
                        <div class="detail-top">
                            <img src="../assets/img/dumuser.png" width="50">
                            <h5 class="fs-15 p-t-4">{{review.username}}</h5>                                     
                            <h5 class="fs-12">{{review.timeReview}}</h5>
                        </div>
                        <small class="text-muted">{{review.textReview}}</small>
                    </div>                    
                </div>             
            </div>
        </div>        
...
export default {
    data:()=>({
        ...
        dataPemilikRekening:
            {
                statusKredibel:'Unverified',
                ratingKredibel:'2.1',
                laporanKredibel:'0',
                pemilik:'Anton Kumala',
                negara:'Indonesia',
                bank:'BRI',
            }
        ,
    ...
    methods : {
        go(){
            this.norekening = this.$route.params.norekening
            const config = {
                method : 'get',
                url : "https://fishcek.herokuapp.com/api/v1/cekPenipuan",
            }
